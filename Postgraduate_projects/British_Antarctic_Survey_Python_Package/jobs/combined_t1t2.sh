#!/bin/bash
#SBATCH -J combined_t1t2       # Job name
...
#SBATCH --cpus-per-task=8      # Adjust based on how parallel your Python is
#SBATCH --ntasks=1             # One task (no MPI)
#SBATCH --time=03:00:00        # Max wall time
#SBATCH --mail-type=ALL
#SBATCH --no-requeue
#SBATCH --output=combined_t1t2.out
...
# Run your script
python scripts/combined_t1t2.py