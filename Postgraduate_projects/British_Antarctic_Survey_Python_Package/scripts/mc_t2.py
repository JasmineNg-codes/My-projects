...
for n in train_counts:
    ...
    for seed in range(num_seeds):
        ...
        LPPreprocess(
            impath=os.path.join(project_root, "data_2/t2/images"),
            lppath=os.path.join(project_root, "data_2/t2/annotations"),
            train_ratio=0.8,
            seed=seed,
            output_dir=os.path.join(project_root, "data_2/t2")
        )

        train_impath = os.path.join(project_root, "data_2/t2/train_images")
        train_lppath = os.path.join(project_root, "data_2/t2/train_annotations")
        test_impath = os.path.join(project_root, "data_2/t2/test_images")
        test_lppath = os.path.join(project_root, "data_2/t2/test_annotations")
...
results_dir = os.path.abspath(os.path.join(project_root, "results", "mc_t2"))
os.makedirs(results_dir, exist_ok=True)
csv_path = os.path.join(results_dir, "mc_t2.csv")
